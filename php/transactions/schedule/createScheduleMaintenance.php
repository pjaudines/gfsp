<?php
    ...
    $sql = "INSERT INTO `sched_maintenance`( `maintenanceID`,`clientName`, `startDate`, `EndDate`, `Duration`, `scheduleAddress`) VALUES (NULL, '$clientName', '$startDate', '$EndDate', '$Duration', '$clientAddress')";
