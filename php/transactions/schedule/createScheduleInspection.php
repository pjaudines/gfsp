<?php
    ...
    $sql = "INSERT INTO `sched_inspection`( `schedID`,`clientName`, `startDate`, `EndDate`, `Duration`, `scheduleAddress`) VALUES (NULL, '$clientName', '$startDate', '$EndDate', '$Duration', '$clientAddress')";
