...
<head>
  ...
  <script>
    $(document).ready(function(){
        ...
        <?php require 'inventoryChart.php'?>
</head>
...
<div class="form-group">
            ...
            <select class="form-control selectpicker input-sm" data-style="btn-primary" id="select-report" name="filterbutton">
                ...
                <option value="outgoing">Outgoing Supplies</option>
            </select>
        </div>
        <div id="chartContainer1"  class="current reporttype" style="width: 100%; height: 300px"></div>
        <div id="chartContainer2" class="incoming reporttype" style="width: 100%; height: 300px"></div>
        <div id="chartContainer3" class="outgoing reporttype" style="width: 100%; height: 300px"></div>
