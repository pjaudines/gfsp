    ...
    <div class="modal fade" id="addItem" role="dialog" style="width: 100%:">
        <div class="modal-dialog" style="max-width: 500px;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label>Item Type</label><sup id="addErroritemType" class="input-error"></sup>
                    ...
                    <div class="row">
                    <div class="col-sm-12">
                    <label>Item Name</label><sup id="addErrorItemName" class="input-error"></sup>
                ...
                <label>Quantity</label><sup id="addErorItemQuantity" class="input-error"></sup>
                <input type="number" class="form-control" name="itmQuantity" min="1" id="itmQty" requried>
                <br>
                <div class="row">
                <div class="col-sm-12">
                <label>
                ...
                <select class="form-control" id="maintenanceType"><label id="addErrorMaintenanceType" class="input-error"></label>
                    <option value="none">Select maintenance type</option>    
            ...
            <div class="modal-footer">
                <input type="hidden" value="<?php echo "".$_POST['maintenanceID']?>" name="maintenanceID" id="maintenanceID">                                
