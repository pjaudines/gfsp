    ...
    <div class="modal fade" id="addItem" role="dialog" style="width: 100%:">
        <div class="modal-dialog" style="max-width: 500px;">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" id="txtLocation" placeholder="Please enter the location">
                <br>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" value="<?php echo "".$_POST['installationID']?>" name="installationID" id="installationID">                                
