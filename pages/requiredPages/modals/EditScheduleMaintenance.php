<?php
    ...
    ?>
    <div class="modal fade" id="edit<?php echo $fetch['maintenanceID'];?>" role="dialog" style="width: 600px; top: 20%;left: 35%;">
        <div class="modal-dialog">
            <!-- Modal content-->
            <form action="../../php/transactions/schedule/updateScheduleMaintenance.php" method="post" onsubmit="return confirm('Save the changes?');">
