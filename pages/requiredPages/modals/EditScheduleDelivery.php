<?php
    ...
    ?>
    <div class="modal fade" id="edit<?php echo $fetch['schedDeliveryID'];?>" role="dialog" style="width: 600px; top: 20%;left: 35%;">
        <div class="modal-dialog">
            <!-- Modal content-->
            <form action="../../php/transactions/schedule/updateSchedDelivery.php" method="post" onsubmit="return confirm('Save the changes?');">
            ...
            <div class="modal-footer">
                <input type="hidden" value="<?php echo $fetch['schedDeliveryID']?>" name="schedDeliveryID">
