...
<div class="modal fade" id="addNewTransactionInspection" role="dialog" style="width: 100%;">
        <div class="modal-dialog" style="max-width: 400px;">
            <!-- Modal content-->
            <form action="../../php/transactions/inspection/createInspection.php" method="post" method="post" onsubmit="return confirm('Create a new Inspection transaction?');" >
