        ...
        <div class="content-wrapper">
          <div class="row purchace-popup">
            <div class="col-12">          
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/inspectionExportPDF.php" enctype="multi-part/form-data">
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/inspectionIndex.php" enctype="multi-part/form-data">
                    ...
                    <table class="table datatable" id="walkInDataTable">
                        ...
                        <tbody>    
                            <?php
                                ...
                                $query = $conn->query("select * from `transactions_inspection-items`,`transactions_inspection` WHERE `transactions_inspection-items`.inspectionID=transactions_inspection.inspectionID") or die(mysqli_error());
