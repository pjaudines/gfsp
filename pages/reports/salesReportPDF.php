        ...
        <div class="content-wrapper">
          <div class="row purchace-popup">
            <div class="col-12">          
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/exportPDF.php" enctype="multi-part/form-data">
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/salesIndex.php" enctype="multi-part/form-data">
                    ...
                    <table class="table datatable" id="walkInDataTable">
                        ...
                        <tbody>    
                            <?php
                                ...
                                $query = $conn->query("select * from `transactions_sales-items` ") or die(mysqli_error());
