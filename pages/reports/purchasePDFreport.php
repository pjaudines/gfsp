        ...
        <div class="content-wrapper">
          <div class="row purchace-popup">
            <div class="col-12">          
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/purchaesExportPDF.php" enctype="multi-part/form-data">
                ...
                <form role="form" class="form-horizontal" method="post" action="../../php/reports/purchaseIndex.php" enctype="multi-part/form-data">
                    ...
                    <table class="table datatable" id="walkInDataTable">
                        ...
                        <tbody>    
                            <?php
                                ...
                                $query = $conn->query("select * from `transactions_purchaseorder-items`,`transactions_purchaseorders` WHERE `transactions_purchaseorder-items`.purchaseID=transactions_purchaseorders.purchaseID") or die(mysqli_error());
