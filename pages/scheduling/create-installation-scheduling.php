      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row purchace-popup">
            ...
            <div class="col-12">
                <!--INSERT CODE HERE -->
                <button class="btn btn-primary" data-toggle="modal" data-target="#addNewScheduleInstallation" style="margin-bottom: 20px;"><i class="menu-icon mdi mdi-account-plus"></i> Add New Schedule of Installation</button>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0;">
                                        ...
                                        <input type="hidden" value="<?php echo $fetch['client']?>"  name="clientName">                                            
                                            <button type="button" data-toggle="modal" data-target="#edit<?php echo $fetch['installationID'];?>" stye="margin:0;" type="button" class="btn btn-icons btn-rounded btn-success"><i class='menu-icon mdi mdi-pencil'></i></button>
                                            </form>
        ...
        <?php
           include "../requiredPages/modals/addNewScheduleInstallation.php";
           include "../requiredPages/modals/EditScheduleInstallation.php";
        ?>
